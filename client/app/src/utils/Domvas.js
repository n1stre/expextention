...
var supportsCSSText = window.getComputedStyle(document.body).cssText !== ''

function copyCSS (elem, origElem, log) {
  var computedStyle = window.getComputedStyle(origElem)
...
export const toImage = (origElem, callback, width, height, left, top) => {
  left = (left || 0)
  top = (top || 0)
